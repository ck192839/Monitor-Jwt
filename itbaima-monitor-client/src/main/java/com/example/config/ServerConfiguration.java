...
public class ServerConfiguration implements ApplicationRunner {
    ...
    private void saveConfigurationToFile(ConnectionConfig config) {//本地保存服务端连接信息
